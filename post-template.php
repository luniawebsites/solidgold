...
<div role="main"> <!-- This is used instead of <main> to ensure CSS grid works -->
	...
	<article class="pad-respond-xy-mob theme-light-grey-mob" id="article_post" aria-labelledby="article_post_h1_title">

		<h1 hidden>Blog post</h1> <!-- For accessiblity audit only, Google does not see PHP script's H1 as semantic-->
					...
					if ($status == 200) {
						...
						if (count($break_title_o) > 1) {
							...
							echo "
								...
								<h1 id='article_post_h1_title'>". $title . "</h1>
								<p>". $intro . "</p>
								". $body . "
							";
						}

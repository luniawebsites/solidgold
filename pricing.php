	...
	<header class="pattern-channel-masthead flow-ttb-mob flow-ltr-tab pad-respond-xy-mob theme-dark-grey border-b-mob">
		...
		<div class="flow-ttb-mob width-100 constrain">
			...
			<div class="flow-ttb-mob pad-respond-y-mob align-fs-mob">
				...
				<p>Our hosting charges start at <strong>R39 per month</strong> and only start increasing once you've made more than a dozen or so episodes.</p>
				<br />
				<p>Below is a calculator that will give you some insight into the estimated costs for 3 tiers of production.</p>
				</header>
